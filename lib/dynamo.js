...
module.exports = {
  ...
  putMessage: (message) => {
    // console.log('ma', message, messageAttributes)
    // message.category = messageAttributes.category.StringValue;
    // message.group = messageAttributes.group.StringValue;
    message.created = message.Attributes.SentTimestamp;
    var pParams = {
  ...
  getAllMessages: (limit) => {
    return new Promise((resolve, reject) => {
      var qParams = {
        TableName : messagetable,
        Limit: limit,
        AttributesToGet: ['MessageId','Body', 'MessageAttributes', 'Attributes'],
